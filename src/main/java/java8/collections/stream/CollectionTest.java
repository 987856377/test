...
//        userList.java8.collections.stream().forEach(user -> {
...
//        numbers1.java8.collections.stream().forEach(num->System.out.println(Thread.currentThread().getName() + ": " + num));
//
//        System.out.println("-------------------------------------------");
//
...
//
//        Set<Integer> collect = numbers1.java8.collections.stream().collect(Collectors.toSet());
